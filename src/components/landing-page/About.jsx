...
const About = () => {
  return (
    <section className='flex w-screen relative'>
      <div className=''>
      <Image
        className='items-center flex flex-1 w-full h-fit object-contain relative max-[1160px]:hidden'
        src={aboutimg}
        alt="About us"
      />
      <div className='max-[1160px]:bg-[#FDF7F7]  about-content items-center gap-20 mx-20 max-[1160px]:mx-0 max-[1160px]:p-20 flex flex-row justify-between'>
        <Image
          src={image}
          width={450}
          height={450}
